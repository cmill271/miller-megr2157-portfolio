...
## Analyze
Task A:
I have selected the following Github portfolios for Task A: [diegocabello](https://gitlab.com/diegocabello), and [OpenAI](https://github.com/openai).

The first portfolio we will be analyzing is that of user diegocabello. The format of the page is simple in its design, with the bulk of the work being divided into two categories: contributed projects, and personal projects. This is as simple as the navigation gets, with the projects themselves being titled in a manner than makes further navigation quite difficult. As long as the searcher knows what they are looking for, it will be easy to find, but if you do not know the exact project name it will be difficult to find. Documentation is hit or miss on the projects, with the quality varying from in-depth explanations to short blurbs about a specific part of the project and nothing else. These issues with the Documentation bleed over into any documentation on reasoning, with any changes made having minimal or vague reasonings. Numerous fixes or changes were justified with simply "correction" or "fixed". Overall the tone of the page is closer to that of a hobbyist than that of a professional engineer. 

The second portfolio if for the company, OpenAI. The difference between the two is stark. The page is well laid out, and easy to navigate. The most used/useful projects are pinned as the first thing you see, and everything is well labeled so that a user may find what they are looking for, even if they are unaware of the specific project name or repository. Read.me files are well written, and all changes made are justified and easily reproducible. This provides a polished and easy to navigate profile, which is to be expected for a large corporation."
